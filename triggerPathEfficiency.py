...
def main():
    ...
    triggerPath1_1='PFHT380_SixPFJet32_DoublePFBTagCSV_2p2'
    triggerPath1_2='PFHT430_SixPFJet40_PFBTagCSV_1p5'
    ...
    legg.AddEntry(h_jetHtT1_0, "PFHT_DoubleDeepB_trigger", "l")
    legg.AddEntry(h_jetHtT1_1, "PFHT_DoubleB_trigger", "l")
    legg.AddEntry(h_jetHtT1_2, "PFHT_SingleB_trigger", "l")
    legg.AddEntry(h_jetHtT2, triggerPath2, "l")
    legg.AddEntry(h_jetHtT3_1, " combination1 ", "l")
    legg.AddEntry(h_jetHtT3_2, " combination2 ", "l")
    legg.AddEntry(h_jetHtT3_2, " combination3 ", "l")
    ...
    triggerCanvas.cd(2)
    h_jetHtTriggerRatio1 = (h_jetHtT1_0).Clone("h_jetPtTriggerRatio1")
    h_jetHtTriggerRatio1.Divide(h_jetHt)
    h_jetHtTriggerRatio1.SetLineStyle(2)
    h_jetHtTriggerRatio1.Draw()
    h_jetHtTriggerRatio1_1 = (h_jetHtT1_1).Clone("h_jetPtTriggerRatio1_1")
    h_jetHtTriggerRatio1_1.Divide(h_jetHt)
    h_jetHtTriggerRatio1_1.SetLineStyle(2)
    h_jetHtTriggerRatio1_1.Draw('same')
    ...
    legg2 = ROOT.TLegend(0.57, 0.1,0.85, 0.33)
    legg2.AddEntry(h_jetHtTriggerRatio1, "PFHT_DoubleB_trigger", "l")
    legg2.AddEntry(h_jetHtTriggerRatio1_1, "PFHT_DoubleB_trigger", "l")
    legg2.AddEntry(h_jetHtTriggerRatio1_2, "PFHT_SingleB_trigger", "l")
    legg2.AddEntry(h_jetHtTriggerRatio2, triggerPath2, "l")
    legg.AddEntry(h_jetHtTriggerRatio3_1, " combination1 ", "l")
    legg.AddEntry(h_jetHtTriggerRatio3_2, " combination2 ", "l")
    legg.AddEntry(h_jetHtTriggerRatio3_3, " combination3 ", "l")
    ROOT.gStyle.SetLegendTextSize(0.04)
    ...
    h_muonPtTriggerRatio1_1 = (h_muonPtT1_1).Clone("h_muonPtTriggerRatio1_1")
    h_muonPtTriggerRatio1_1.Divide(h_muonPt)
    h_muonPtTriggerRatio1_1.SetLineStyle(2)
    h_muonPtTriggerRatio1_1.Draw('same')
    ...
    legg3 = ROOT.TLegend(0.57, 0.1,0.85, 0.33)
    legg3.AddEntry(h_muonPtTriggerRatio1, "PFHT_DoubleB_trigger", "l")
    legg3.AddEntry(h_muonPtTriggerRatio1_1, "PFHT_DoubleB_trigger", "l")
    legg3.AddEntry(h_muonPtTriggerRatio1_2, "PFHT_SingleB_trigger", "l")
    legg3.AddEntry(h_muonPtTriggerRatio2, triggerPath2, "l")
    legg3.AddEntry(h_muonPtTriggerRatio3_1, " combination1 ", "l")
    legg3.AddEntry(h_muonPtTriggerRatio3_2, " combination2 ", "l")
    legg3.AddEntry(h_muonPtTriggerRatio3_3, " combination3 ", "l")
    ROOT.gStyle.SetLegendTextSize(0.04)
    ...
    legend = ROOT.TLegend(0.57, 0.7,0.85, 0.87)
    legend.AddEntry(h_muonPt, "no trigger", "l")
    legend.AddEntry(h_muonPtT1, "PFHT_DoubleDeepB_trigger", "l")
    legend.AddEntry(h_muonPtT1_1, "PFHT_DoubleB_trigger", "l")
    legend.AddEntry(h_muonPtT1_2, "PFHT_SingleB_trigger", "l")
    ...
    legend.AddEntry(h_muonPtT3_2, " combination3 ", "l")
    ROOT.gStyle.SetLegendTextSize(0.04)
