...
def main():
    ...
    legg2 = ROOT.TLegend(0.57, 0.1,0.85, 0.5)
    ...
    legg2.AddEntry(h_jetHtTriggerRatio3_1, " combination1 ", "l")
    legg2.AddEntry(h_jetHtTriggerRatio3_2, " combination2 ", "l")
    legg2.AddEntry(h_jetHtTriggerRatio3_3, " combination3 ", "l")
    ROOT.gStyle.SetLegendTextSize(0.04)
    ...
    legg3 = ROOT.TLegend(0.57, 0.1,0.85, 0.5)
